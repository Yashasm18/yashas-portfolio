...
const WhatIDo = () => {
  ...
  />
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                {config.skills.develop.tools.map((tool, index) => <div key={index} className="what-tags">{tool}</div>)}
              </div>
  ...
  />
            ...
            <div className="what-content-in">
              ...
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                {config.skills.design.tools.map((tool, index) => <div key={index} className="what-tags">{tool}</div>)}
              </div>
              <div className="what-arrow" />
            </div>
          </div>
